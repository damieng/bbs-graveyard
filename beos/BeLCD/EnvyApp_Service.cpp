...
EnvyApp::EnvyApp():BApplication("application/x-vnd.Envy-BeLCD_Service") 
{
	...
	switch (si.cpu_type) { // Build processor name
		case B_CPU_PPC_601: strcpy(cpu,"PowerPC 601"); break;
		case B_CPU_PPC_603: strcpy(cpu,"PowerPC 603"); break;
		case B_CPU_PPC_603e: strcpy(cpu,"PowerPC 603e"); break;
		case B_CPU_PPC_604: strcpy(cpu,"PowerPC 604"); break;
		case B_CPU_PPC_604e: strcpy(cpu,"PowerPC 604e"); break;
		case B_CPU_INTEL_PENTIUM: 
		case B_CPU_INTEL_PENTIUM75: strcpy(cpu,"Pentium"); break;
		case B_CPU_INTEL_PENTIUM_486_OVERDRIVE:
		case B_CPU_INTEL_PENTIUM75_486_OVERDRIVE: strcpy(cpu,"PentiumOD"); break;
		case B_CPU_INTEL_PENTIUM_PRO: strcpy(cpu,"PentiumPro"); break;
		case B_CPU_INTEL_PENTIUM_II: 
		case B_CPU_INTEL_PENTIUM_II_MODEL_5: strcpy(cpu,"Pentium II"); break;		
		case B_CPU_AMD_X86: strcpy(cpu,"AMD x86"); break;
		case B_CPU_AMD_K5_MODEL0: 
		case B_CPU_AMD_K5_MODEL1: 
		case B_CPU_AMD_K5_MODEL2:
		case B_CPU_AMD_K5_MODEL3: strcpy(cpu,"AMD K5"); break;
		case B_CPU_AMD_K6_MODEL6:
		case B_CPU_AMD_K6_MODEL7:
		case B_CPU_AMD_K6_MODEL8:
		case B_CPU_AMD_K6_MODEL9: strcpy,(cpu,"AMD K6"); break;
		case B_CPU_CYRIX_X86: strcpy(cpu,"Cyrix x86"); break;
		case B_CPU_CYRIX_GXm: strcpy(cpu,"Cyrix GX"); break;
		case B_CPU_CYRIX_6x86MX: strcpy(cpu,"Cyrix 6x86MX"); break;
		default: strcpy(cpu,"Processor");
	};
...
/*					case 0: // System screen
						...
						MOSendText("Thread");
						break; */
					case 0: sprintf(output,"%c%c CPU LOAD 00.0%% %c%c", 0xFF,0xFF,0xFF,0xFF);
						MOSendText(output);
						MOSetCursorPosition(1,2);
						MOSendText("1");
						MOSetCursorPosition(1,3);
